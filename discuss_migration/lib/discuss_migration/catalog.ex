defmodule DiscussMigration.Catalog do
  @moduledoc """
  The Catalog context.
  """
  ...
  def list_categories_by_id(categories_ids) do
    Repo.all(from c in Category, where: c.id in ^categories_ids)
  end

  ## working from phoenix tutorial example

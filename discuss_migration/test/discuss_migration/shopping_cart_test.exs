defmodule DiscussMigration.ShoppingCartTest do
  use DiscussMigration.DataCase

  alias DiscussMigration.ShoppingCart

  describe "carts" do
    alias DiscussMigration.ShoppingCart.Cart

    import DiscussMigration.ShoppingCartFixtures
  ...
  describe "cart_items" do
    alias DiscussMigration.ShoppingCart.CartItem

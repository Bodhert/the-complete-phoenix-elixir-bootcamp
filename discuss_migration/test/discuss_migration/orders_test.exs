defmodule DiscussMigration.OrdersTest do
  use DiscussMigration.DataCase

  alias DiscussMigration.Orders

  describe "orders" do
    alias DiscussMigration.Orders.Order

    import DiscussMigration.OrdersFixtures
  ...
  describe "order_line_items" do
    alias DiscussMigration.Orders.LineItem

defmodule DiscussMigration.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `DiscussMigration.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> DiscussMigration.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> DiscussMigration.ShoppingCart.create_cart_item()
